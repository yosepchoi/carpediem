    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('withdraw', models.DecimalField(blank=True, decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recordapp.Entry')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.AddField(
            model_name='game',
            name='product',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='recordapp.Product'),
        ),
        migrations.AddField(
            model_name='exit',
            name='game',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recordapp.Game'),
        ),
        migrations.AddField(
            model_name='entry',
            name='game',
        ...
        migrations.AddField(
            model_name='code',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recordapp.Product'),
        ),
    ]
